...
content = re.sub(r'when \(tipoComida?.lowercase\(\)\) \{.*?\n    \}', '''when (tipoComida?.lowercase()) {
        "pizza" -> Icons.Default.Star
        "burger", "hamburguesa" -> Icons.Default.Star
        "pasta", "italiana" -> Icons.Default.Star
        "café", "cafe", "cafeteria" -> Icons.Default.Star
        "postres", "dulces" -> Icons.Default.Star
        "tacos", "mexicana" -> Icons.Default.Star
        "pollo", "pollo frito" -> Icons.Default.Star
        "china", "asiatica" -> Icons.Default.Star
        "mariscos" -> Icons.Default.Star
        "bebidas" -> Icons.Default.Star
...
content2 = content2.replace('import androidx.compose.material.icons.filled.Search', 'import androidx.compose.material.icons.filled.Search\nimport androidx.compose.material.icons.filled.Star\n')
